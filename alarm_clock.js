...
function alarmSet() {
    ...
    deleteButton.style.backgroundColor = "#e77111";
    deleteButton.style.color = "azure";
    ...
    turnButton.style.backgroundColor = "#e77111";
    turnButton.style.color = "azure";
    turnButton.style.borderRadius = "10px";
    //appending button to print box
